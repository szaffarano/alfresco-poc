package afip.tecno.alfresco.aspect;
...
public class RateableAspectTest {
	...
	private final QName RATING = QName.createQName(TecnoRatingsModel.NAMESPACE_TECNO_RATINGS_CONTENT_MODEL,
			TecnoRatingsModel.PROP_AVERAGE_RATING);
	private final QName TOTAL = QName.createQName(TecnoRatingsModel.NAMESPACE_TECNO_RATINGS_CONTENT_MODEL,
			TecnoRatingsModel.PROP_TOTAL_RATING);
	private final QName COUNT = QName.createQName(TecnoRatingsModel.NAMESPACE_TECNO_RATINGS_CONTENT_MODEL,
			TecnoRatingsModel.PROP_RATING_COUNT);
	...
	public void testAddRateableAspect() {
		...
		nodeService.addAspect(content, QName.createQName(TecnoRatingsModel.NAMESPACE_TECNO_RATINGS_CONTENT_MODEL,
				TecnoRatingsModel.ASPECT_SCR_RATEABLE), aspectProps);
