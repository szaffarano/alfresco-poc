...
public class RatingTest {
    ...
    private final QName RATING = QName.createQName(
    		...
    		TecnoRatingsModel.PROP_RATING);
    private final QName RATER = QName.createQName(
    		TecnoRatingsModel.NAMESPACE_TECNO_RATINGS_CONTENT_MODEL,
    		TecnoRatingsModel.PROP_RATER);
    ...
    public void ratingTypeTest() {
        ...
        // add the aspect
        nodeService.addAspect(content, QName.createQName(TecnoRatingsModel.NAMESPACE_TECNO_RATINGS_CONTENT_MODEL, TecnoRatingsModel.ASPECT_SCR_RATEABLE), null);
    ...
    public NodeRef createRating(NodeRef content, int rating, String rater) {
	    ...
	    ChildAssociationRef association = nodeService.createNode(
	                    ...
	                    QName.createQName(
	                    		TecnoRatingsModel.NAMESPACE_TECNO_RATINGS_CONTENT_MODEL,
	                    		TecnoRatingsModel.TYPE_SCR_RATING),
	                    contentProps
	                    );
